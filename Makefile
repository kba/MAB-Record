# This Makefile is for the MAB::Record extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/MAB/Record.pm]
...
#     VERSION_FROM => q[lib/MAB/Record.pm]
#     clean => { FILES=>q[MAB-Record-*] }
...
INST_LIBDIR      = $(INST_LIB)\MAB
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\MAB
...
TO_INST_PM = lib/MAB/Batch.pm \
	lib/MAB/Field.pm \
	lib/MAB/File.pm \
	lib/MAB/File/MAB2.pm \
	lib/MAB/Record.pm

PM_TO_BLIB = lib/MAB/Batch.pm \
	blib\lib\MAB\Batch.pm \
	lib/MAB/Record.pm \
	blib\lib\MAB\Record.pm \
	lib/MAB/File.pm \
	blib\lib\MAB\File.pm \
	lib/MAB/File/MAB2.pm \
	blib\lib\MAB\File\MAB2.pm \
	lib/MAB/Field.pm \
	blib\lib\MAB\Field.pm
...
Record.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"MAB::Record\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name:               MAB-Record" >> META_new.yml
	$(NOECHO) $(ECHO) "version:            0.01" >> META_new.yml
	$(NOECHO) $(ECHO) "abstract:           Perl extension for handling MAB2 records" >> META_new.yml
	$(NOECHO) $(ECHO) "author:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - Johann Rolschewski <rolschewski@gmail.com>" >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>Perl extension for handling MAB2 records</ABSTRACT>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>Johann Rolschewski &lt;rolschewski@gmail.com&gt;</AUTHOR>" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/MAB/Batch.pm blib\lib\MAB\Batch.pm \
	  lib/MAB/Record.pm blib\lib\MAB\Record.pm \
	  lib/MAB/File.pm blib\lib\MAB\File.pm \
	  lib/MAB/File/MAB2.pm blib\lib\MAB\File\MAB2.pm \
	  lib/MAB/Field.pm blib\lib\MAB\Field.pm 
